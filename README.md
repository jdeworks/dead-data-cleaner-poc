...
- **Interactive demo** over three real scans (the ripgrep source in Rust, tmux in C,
  and our own tmux-poc harness in Python): an explorable treemap, a sortable findings table with a
